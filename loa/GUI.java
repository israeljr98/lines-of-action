...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuCheckBox("AI->Black", false ,this::aiBlack);
        addMenuCheckBox("AI->White", true, this::aiWhite);
        addMenuButton("Help->About", (s) -> displayText("About", ABOUT_TEXT));
        addMenuButton("Help->Help", (s) -> displayText("Help", HELP_TEXT));
    ...
    /** Toggles between auto or manual player configuration for black.*/
    private void aiBlack(String btnLabel) {
        if (isSelected(btnLabel)) {
    ...
    /** Toggles between auto or manual player configuration for white.*/
    private void aiWhite(String btnLabel) {
        if (isSelected(btnLabel)) {
    ...
    private void displayText(String title, String textResource) {
        ...
        InputStream resource = GUI.class.getClassLoader().getResourceAsStream(textResource);
     ...
     */
    private ArrayBlockingQueue<String> _pendingCommands = new ArrayBlockingQueue<>(5);
